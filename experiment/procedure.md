...
5. Change the gate current value (I<sub>g2</sub>, I<sub>g3</sub>) and repeat steps 3 and 4.</li>Plot the graph between V<sub>ak</sub> and I<sub>a</sub> , denoting I<sub>L</sub>, I<sub>H</sub>, V<sub>BO</sub>'s.
